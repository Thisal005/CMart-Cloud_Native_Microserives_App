...
const envSchema = {
  PORT: { type: 'number', required: false, default: 3005 },
  ...
  ORDER_SERVICE_URL: { type: 'string', required: true, default: 'http://localhost:3004' },
  DB_POOL_MAX: { type: 'number', required: false, default: 10 },
  DB_POOL_IDLE_TIMEOUT: { type: 'number', required: false, default: 30000 },
  DB_POOL_CONNECTION_TIMEOUT: { type: 'number', required: false, default: 10000 },
  PAYMENT_GATEWAY: { type: 'string', required: false, default: 'MOCK' },
