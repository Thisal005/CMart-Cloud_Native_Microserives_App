...
exports.CreateUsersTable1720267200000 = void 0;
class CreateUsersTable1720267200000 {
    ...
    `);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_users_role_status" ON "users" ("role", "status")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_users_status" ON "users" ("status")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_users_email_unverified" ON "users" ("email") WHERE "email_verified" = FALSE`);
...
exports.CreateUsersTable1720267200000 = CreateUsersTable1720267200000;
