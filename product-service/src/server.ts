...
async function bootstrap(): Promise<void> {
  try {
    ...
    if (config.databaseUrl) {
      ...
      console.log('✅ Database connection established (ProductService)');
      await AppDataSource.runMigrations();
      console.log('✅ Database migrations executed (ProductService)');
    } else {
      console.log('⚠️ DATABASE_URL is not set. Database integration is disabled for ProductService.');
    }
