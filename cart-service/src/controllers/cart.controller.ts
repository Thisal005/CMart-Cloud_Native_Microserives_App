...
export class CartController {
  ...
  private async getCart(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      ...
      res.json(ApiResponseHelper.success(cart, undefined, req));
    } catch (error: any) {
      next(error);
    }
  }
  ...
  private async addItem(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      ...
      res.json(ApiResponseHelper.success(cart, 'Product added to cart successfully', req));
    } catch (error: any) {
      next(error);
    }
  }
  ...
  private async updateQuantity(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      ...
      res.json(ApiResponseHelper.success(cart, 'Item quantity updated successfully', req));
    } catch (error: any) {
      next(error);
    }
  }
  ...
  private async removeItem(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      ...
      res.json(ApiResponseHelper.success(cart, 'Item removed from cart successfully', req));
    } catch (error: any) {
      next(error);
    }
  }
  ...
  private async clearCart(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      ...
      res.json(ApiResponseHelper.success(null, 'Cart cleared successfully', req));
    } catch (error: any) {
      next(error);
    }
  }
